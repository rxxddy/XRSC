...
export const HeadingImage: React.FC<HeadingImage> = ({
  ...
  return (
    <div className="self-start overflow-hidden rounded-xl  xs:h-[11.25rem] xs:w-[11.25rem] lg:mx-auto lg:h-auto lg:w-full lg:self-center">
      {isLoading ? (
        <div
          role="status"
        ...
        <div className="mx-auto h-full w-full self-center flex justify-end">
          {src ? (
            <MediaRenderer
              src={src}
              width="100%"
              height="100%"
              className="h-full w-full object-cover lg:w-[70%] lg:h-[70%]"
            />
          ) : (
